...
export default function MockupSprite() {
  return (
    <svg width="0" height="0" style={{ position: 'absolute' }} aria-hidden="true">
      ...
      <symbol id="i-phone" viewBox="0 0 24 24"><path d="M6.4 3.5h3l1.5 4-2 1.4a11 11 0 0 0 5 5l1.4-2 4 1.5v3a2 2 0 0 1-2.2 2A16.5 16.5 0 0 1 4.5 5.7 2 2 0 0 1 6.4 3.5z" /></symbol>
      <symbol id="i-key" viewBox="0 0 24 24"><circle cx="8" cy="8" r="3.6" /><path d="M10.6 10.6L20 20M16.5 16.5l2-2M14.5 14.5l2.5-2.5" /></symbol>
      ...
      <symbol id="i-book" viewBox="0 0 24 24"><path d="M12 6.6C10.3 5.3 7.9 4.8 5 5.1v12.4c2.9-.3 5.3.2 7 1.5 1.7-1.3 4.1-1.8 7-1.5V5.1c-2.9-.3-5.3.2-7 1.5z" /><path d="M12 6.6V19" /></symbol>
      <symbol id="i-ticket" viewBox="0 0 24 24"><path d="M4 8.5A1.5 1.5 0 0 1 5.5 7h13A1.5 1.5 0 0 1 20 8.5v2a2 2 0 0 0 0 4v2a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 16.5v-2a2 2 0 0 0 0-4z" /><path d="M14 7.5v9" /></symbol>
